...
//!
//! * [num_bigint](https://crates.io/crates/num-bigint). A slow pure Rust implementation without
...
//! This is enabled with the `rug` feature and disabling default features.
