...
* BREAKING: Changed all functions taking `&mut Read/Write` to just take `Read/Write` as specified in [the library guidelines](https://rust-lang.github.io/api-guidelines/interoperability.html#c-rw-value).
